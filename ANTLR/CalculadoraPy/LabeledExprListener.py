...
class LabeledExprListener(ParseTreeListener):
    ...
    # Enter a parse tree produced by LabeledExprParser#FuncCall.
    def enterFuncCall(self, ctx:LabeledExprParser.FuncCallContext):
        pass

    # Exit a parse tree produced by LabeledExprParser#FuncCall.
    def exitFuncCall(self, ctx:LabeledExprParser.FuncCallContext):
        pass
